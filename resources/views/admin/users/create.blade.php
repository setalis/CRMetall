                ...
                <div class="col-12 col-lg-6">
                    <div class="card">
                        <div class="card-body">
                            <!-- Name -->
                            <div class="mt-4">
                                <label for="name" class="form-label" for="name" value="{{__('Name')}}" />Имя</label>
                            ...
                            <div class="mt-4">
                                ...
                                <div class="input-group">
                                    <input type="email" class="form-control" name = "email" id="email" placeholder="name@example.com" value="{{ old('email')}}" required autocomplete="username">
                                    <span class="input-group-text" id="basic-addon2">
                                        @
                                    </span>
                                </div>
