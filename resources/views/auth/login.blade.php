<x-guest-layout>
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            ...
            <div class="row justify-content-center form-bg-image" data-background-lg = "{{ asset('/assets/img/pages/sign-in.jpg') }}">
                        ...
                        <form method = "POST" action="{{ route('login') }}" class="mt-4">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" id = "email" placeholder="example@company.com" type="email" name="email" value="{{ old('email') }}" required autofocus autocomplete="username">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input name ="password" type="password" placeholder="Password" class="form-control" id="password" required autocomplete="current-password">
                                    </div>
